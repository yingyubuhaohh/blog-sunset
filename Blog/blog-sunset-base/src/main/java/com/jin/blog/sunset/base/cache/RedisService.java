...
public class RedisService {
    ...
    public Boolean removeCache(String key) {
        ...
        log.info("删除缓存耗时 key={} time={}", key, endTime - begTime);
        return result;
    }
     ...
     * @return
     */
    public Long removePrefixKeys(String keyPre ){
     ...
     * @param obj
     */
    public void leftPushIfPresent(String key, Object obj){
        this.leftPushIfPresent(key,obj);
